...
Capture every cited web source — with metadata — from the text responses generated by **Claude, Gemini, and ChatGPT**, for [longitudinal](https://www.researchgate.net/publication/408580170_Longitudinal_Prompt_Method_for_Understanding_AI_Search) and [comparative](https://www.digitalmethods.net/Dmi/SummerSchool2026AIsourceVernaculars#A_4._Methodology) source-recurrence analysis.
